...
- 测试日期：2026-07-06
- 被测版本：`resources/skills/execute-task/SKILL.md` —— **工作区未提交版本**（基线 fd13926 + handoff 改动：orchestration.md 四节重写、execution-loop.md 四节适配、新增 references/handoff-templates.md）
