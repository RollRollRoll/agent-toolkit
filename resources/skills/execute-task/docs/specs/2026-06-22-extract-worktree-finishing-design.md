...
```text
resources/skills/setup-worktree/
  SKILL.md  README.md  metadata.yaml
resources/skills/finish-branch/
  SKILL.md  README.md  metadata.yaml
```
...
- `.claude-plugin/plugin.json` 的 `skills` 数组加入 `./resources/skills/setup-worktree`、`./resources/skills/finish-branch`。
